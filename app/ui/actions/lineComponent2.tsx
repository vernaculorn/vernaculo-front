...
const LineComponent2 = () => {
  return (
    <div className='flex flex-col lg:flex-row justify-center w-full px-0 lg:px-5'>
      ...
      {/* PRIMEIRA BOX (TITLE) */}
      <div className='bg-[url("/images/action/imgBG2.png")] bg-no-repeat bg-center bg-cover w-full lg:w-100 lg:min-h-96 max-h-full flex relative'>
      ...
      {/* SEGUNDA BOX (CONTENT) */}
      <div className='flex flex-col relative overflow-hidden text-xl justify-center items-center p-10 [&>div]:p-0 lg:mx-2 bg-[#4b6ddb] w-full lg:w-[50rem] lg:min-h-96 h-full'>
        <p className='w-full text-white'>O Rio Grande do Norte guarda tesouros que ainda não foram descobertos. Eles estão em
          ...
          <Link  className='w-40 text-center bg-transparent border-solid border-4 border-[#333333] text-[#333333]' href={'/acoes/page2'}>Conhecer +</Link>
        </div>
      </div>
    </div>
  )
