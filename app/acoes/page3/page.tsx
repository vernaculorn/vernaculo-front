...
export default function tipografia() {
  return (
    <div className='relative flex flex-col w-full lg:p-10 md:p-10 pt-0 bg-slate-100 gap-5'>
      <div className='bg-[url("/images/action/imgBG3.png")] bg-no-repeat bg-center bg-cover  w-full h-80 flex relative'>
      ...
      <div className='m-5 lg:mx-32 md:mx-10'>
        <div className='flex flex-col m-auto p-8 border-solid border-4 border-[#8260ad] w-full'>
          <div>
